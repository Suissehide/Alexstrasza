...
class OptionController extends AbstractController
{
    ...
    public function edit(Request $request, Option $option) : Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('option_edit', ['id' => $option->getId()]);
        }
    ...
    /**
     * @Route("/{id}/vote", name="add_vote", methods="DELETE")
     */
    public function add_vote(Request $request, Option $option) : Response
    {
    }
}
